...
///
/// A friendly, open design optimized for both web and print typography.
/// Supports a full `wght` (weight) axis from 300 to 800.
const LayrzFont kLayrzFontOpenSans = OpenSansFont();
