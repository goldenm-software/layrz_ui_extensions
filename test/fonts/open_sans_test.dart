...
void main() {
  group('OpenSansFont', () {
    ...
    test('kLayrzFontOpenSans exposes an OpenSansFont instance', () {
      expect(kLayrzFontOpenSans, isA<OpenSansFont>());
      expect(kLayrzFontOpenSans.name, 'Open Sans');
    });
  });
}
